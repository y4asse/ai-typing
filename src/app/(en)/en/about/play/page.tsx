    ...
    <div className="container min-h-screen">
      <div className="pb-20">
        ...
        <div className="mt-10">
          ...
          <p>
            ・As you type the displayed text, you'll earn points based on the time taken, the number of words typed, and
            the number of typing errors. The timer starts when you type the first character.
          </p>
